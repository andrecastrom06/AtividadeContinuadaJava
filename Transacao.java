...
// Esta classe deve ter os seguintes atributos: entidadeCredito, do tipo EntidadeOperadora, entidadeDebito, do tipo EntidadeOperadora, 
// acao, do tipo Acao, tituloDivida, do tipo TituloDivida, valorOperacao, do tipo double, dataHoraOperacao, do tipo LocalDateTime. 
// Deve ter um construtor público que inicializa os atributos. 
// Deve ter métodos get/set públicos para todos os atributos, que são read-only fora da classe.
