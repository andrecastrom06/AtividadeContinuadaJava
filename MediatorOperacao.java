...
public class MediatorOperacao {
    ...
    private final MediatorTituloDivida mediatorTituloDivida = new MediatorTituloDivida();
    private final MediatorEntidadeOperadora mediatorEntidadeOperadora = new MediatorEntidadeOperadora();
